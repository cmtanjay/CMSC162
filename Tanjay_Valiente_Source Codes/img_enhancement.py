    ...
    if not variables.pcx_image_data and variables.file_type == 1:
        ...
        while True:
            ...
            if status:
                ...
                new_frame = cv2.cvtColor(np.array(avg_filtered_img), cv2.COLOR_RGB2BGR)
    ...
    if not variables.pcx_image_data and variables.file_type == 1:
        ...
        while True:
            ...
            if status:
                ...
                new_frame = cv2.cvtColor(np.array(unsharp_masked_img), cv2.COLOR_RGB2BGR)
    ...
    if not variables.pcx_image_data and variables.file_type == 1:
        ...
        while True:
            ...
            if status:
                ...
                new_frame = cv2.cvtColor(np.array(highpass_filtered_img), cv2.COLOR_RGB2BGR)
    ...
    if not variables.pcx_image_data and variables.file_type == 1:
        ...
        while True:
            ...
            if status:
                ...
                new_frame = cv2.cvtColor(np.array(mdn_filtered_img), cv2.COLOR_RGB2BGR)
    ...
    if not variables.pcx_image_data and variables.file_type == 1:
        ...
        while True:
            ...
            if status:
                ...
                new_frame = cv2.cvtColor(np.array(lapla_filtered_img), cv2.COLOR_RGB2BGR)
    ...
    if not variables.pcx_image_data and variables.file_type == 1:
        ...
        while True:
            ...
            if status:
                ...
                new_frame = cv2.cvtColor(np.array(grdn_filtered_img), cv2.COLOR_RGB2BGR)
